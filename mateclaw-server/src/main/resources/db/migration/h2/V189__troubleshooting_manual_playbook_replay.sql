-- V189: immutable manual-candidate replay attestations (H2).
-- Only bounded counters and fingerprints are stored. Replay fixture evidence,
-- raw responses, queries, logs and credentials are deliberately excluded.
