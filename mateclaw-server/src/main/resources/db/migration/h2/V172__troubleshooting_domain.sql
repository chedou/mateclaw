-- V172: deterministic troubleshooting domain (H2).
-- Manual production writes are represented only as aggregate JSON plus external outcomes;
-- this schema intentionally contains no executable tool/action queue.
