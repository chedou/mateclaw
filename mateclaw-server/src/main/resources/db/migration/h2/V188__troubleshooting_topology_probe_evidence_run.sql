-- V188: immutable, Diagnosis-scoped safe projections for topology probe runs (H2).
-- result_json is the canonical DeploymentTopologySopResult projection only;
-- raw Guance responses, DQL, credentials and arbitrary query URLs are forbidden.
