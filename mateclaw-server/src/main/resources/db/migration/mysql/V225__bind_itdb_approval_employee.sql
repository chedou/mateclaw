...
SELECT 1000000961, @itdb_agent_id, id, TRUE, NULL, NOW(), NOW(), 0
FROM mate_skill
WHERE id = 2091870934831804418 AND deleted = 0
LIMIT 1
ON DUPLICATE KEY UPDATE enabled=VALUES(enabled), update_time=VALUES(update_time), deleted=VALUES(deleted);
INSERT INTO mate_agent_skill
    (id, agent_id, skill_id, enabled, config_json, create_time, update_time, deleted)
SELECT 1000000962, @itdb_agent_id, id, TRUE, NULL, NOW(), NOW(), 0
FROM mate_skill
WHERE id = 2091870991194861569 AND deleted = 0
LIMIT 1
ON DUPLICATE KEY UPDATE enabled=VALUES(enabled), update_time=VALUES(update_time), deleted=VALUES(deleted);

INSERT INTO mate_agent_skill
    (id, agent_id, skill_id, enabled, config_json, create_time, update_time, deleted)
SELECT 1000000963, @itdb_agent_id, id, TRUE, NULL, NOW(), NOW(), 0
FROM mate_skill
WHERE id = 2091871049277583362 AND deleted = 0
LIMIT 1
ON DUPLICATE KEY UPDATE enabled=VALUES(enabled), update_time=VALUES(update_time), deleted=VALUES(deleted);

INSERT INTO mate_agent_skill
    (id, agent_id, skill_id, enabled, config_json, create_time, update_time, deleted)
SELECT 1000000964, @itdb_agent_id, id, TRUE, NULL, NOW(), NOW(), 0
FROM mate_skill
WHERE id = 2091871106345283585 AND deleted = 0
LIMIT 1
ON DUPLICATE KEY UPDATE enabled=VALUES(enabled), update_time=VALUES(update_time), deleted=VALUES(deleted);
