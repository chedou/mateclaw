...
.badge-row { display:flex; align-items:center; gap:8px; flex-wrap:wrap; } .conclusion-badge,.status-badge,.confidence-badge { padding:4px 9px; border:1px solid var(--mc-border); border-radius:var(--mc-radius-lg); font-size:10px; font-weight:700; }
...
.summary-grid strong { display:block; margin:10px 0 8px; font-size:var(--mc-text-sm); line-height:1.55; } .summary-grid small { display:block; color:var(--mc-text-secondary); font-size:10px; line-height:1.55; }
.impact-metrics { display:flex; gap:7px; margin:8px 0; } .impact-metrics span { padding:2px 7px; border-radius:var(--mc-radius-xs); color:var(--mc-status-info-text); background:var(--mc-status-info-bg); font-size:10px; } .capability-boundary { color:var(--mc-warning)!important; }
...
.closure-result div b { display:block; margin-top:5px; color:var(--mc-success); font-size:var(--mc-text-sm); } .closure-result>strong { font-size:12px; line-height:1.55; } .closure-result>small { color:var(--mc-text-secondary); font-size:10px; text-align:right; }
...
.timing-strip article { display:grid; grid-template-columns:1fr auto; gap:3px 12px; } .timing-strip span { color:var(--mc-text-secondary); font-size:10px; } .timing-strip b { color:var(--mc-text-secondary); font-size:var(--mc-text-sm); }
.timing-strip small { grid-column:1/-1; color:var(--mc-text-tertiary); font-size:9px; } .timing-strip i { width:5px; height:5px; justify-self:center; border-radius:50%; background:var(--mc-text-tertiary); }
.lifecycle-bar { display:flex; align-items:center; gap:9px; margin-top:19px; padding-top:17px; border-top:1px solid var(--mc-border); } .lifecycle-bar>span { margin-left:5px; color:var(--mc-text-secondary); font-size:10px; }
